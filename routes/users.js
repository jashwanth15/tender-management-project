...
router.put('/profile', authMiddleware, async (req, res) => {
    const { username, email, company, contact } = req.body;
    ...
    try {
        ...
        res.json({ msg: 'Profile updated successfully', user: { username: user.username, email: user.email, company: user.company, contact: user.contact } });
    } catch (err) {
        console.error(err.message);
